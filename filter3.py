    ...
    if content:
        ...
        while i < len(lines):
            ...
            if line.startswith("#EXTINF") and TARGET_NAME.lower() in line.lower():
                ...
                # প্রথম ম্যাচটি বাদ দাও
                if match_count == 1:
                    i += 1
                    continue

                # শুধু দ্বিতীয় ম্যাচটি নাও
                if match_count == 2:
                    if i + 1 < len(lines) and not lines[i + 1].startswith("#"):
                        stream_link = lines[i + 1].strip()

                        # যদি পাওয়া লিংকটি গিটহাবের আরেকটা M3U/M3U8 প্লেলিস্ট হয়,
                        # তবে তার ভেতর ঢুকে আসল লিংক বের করা
